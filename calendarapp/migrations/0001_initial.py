    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participante_acti_academ', models.ManyToManyField(blank=True, help_text='Los participantes de la actividad academica', related_name='participante_acti_academica', through='calendarapp.DetalleActividadAcademica', to='accounts.Persona')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='id_actividad_academica',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='actividad_academica', to='calendarapp.event'),
        ),
        migrations.AddField(
            model_name='detalleactividadacademica',
            name='id_participante',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='persona_participante', to='accounts.persona'),
        ),
        migrations.AddField(
